...
from chop.nn.quantized.modules.llada import LLaDAModelLM
...
class LLaDAEvalHarness(LM):
    def __init__(
        ...
        **kwargs,
        ...
        # Apply MASE quantization if config provided
    ...
    def generate_until(self, requests):
        ...
        for batch in tqdm(batched_requests, desc="Generating..."):
            ...
            batched_input_ids = [
                torch.cat([
                    torch.full((1, max_len - len(ids)), self.tokenizer.pad_token_id, dtype=torch.long, device=self.device),
